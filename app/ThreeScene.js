...
const renderLoading =(
  <div className="relative top-1/2 left-1/2 -mt-4 -ml-2 h-8 w-4 text-black-700">
  <div className="relative z-10 -ml-2 h-8 w-8 animate-bounce">
  ...
  <div className="relative top-4 h-5 w-4 animate-bounce border-l-2 border-gray-200" style={{rotate: "-90deg"}}></div>
  <div className="relative top-4 h-5 w-4 animate-bounce border-r-2 border-gray-200" style={{rotate: "90deg"}}></div>
</div>
);
