...
const renderLoading =(
  <div className="absolute top-1/2 left-1/2 -mt-4 -ml-2 h-8 w-4 text-white-700">
...
const renderLoaded =(
  <div className='info3 grid grid-cols-3'>
            ...
            <svg className="w-6 h-6 ml-[30rem] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 8 14">
...
<p style={{color: "white"}}>
 ...
 <p>
<svg className="w-6 h-6 mr-[27rem] text-gray-800  dark:text-white" style={{display:"flex"}} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 8 14">
