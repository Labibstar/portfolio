    ...
    zIndex:-1}}>
        ...
        <div className="contact1 text-end">
          ...
          <div className="grid ml-[5rem]">
            ...
            <div className="grid grid-cols-3 ml-4 mt-2">

              <a href="https://www.linkedin.com/in/labib-rahman-751106217/" target="_blank" className="ml-[24rem] text-gray-500 hover:text-gray-900 dark:hover:text-blue dark:text-gray-400">
              <svg className="h-6 w-6 " viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a href="https://github.com/Labibstar/" target="_blank" className="ml-[16rem] text-gray-500 hover:text-gray-900 dark:hover:text-black dark:text-gray-400">
            ...
            <a href="mailto:labibstar@gmail.com" target="_blank" className="ml-[8rem] text-gray-500 hover:text-gray-900 dark:hover:text-black dark:text-gray-400">
